...
export default function prescription() {
  ...
  const handleSubmit = async (e) => {
    ...
    const ph = await axios.get(
      `http://localhost:3000/api/getstudentnumber/?username=${username}`
    );
    ...
    const res = await fetch(
      "https://api.green-api.com/waInstance7103832087/sendFileByUrl/9037e1378e404f429d9b24934c7282c7786a8e8a0ef14ee294",
      {
        ...
        body: JSON.stringify({
          chatId: chatid,
          urlFile: imageUrl,
          fileName: "bookissues.jpg",
          caption: `Your issued Book from Librarian${session.user.name}`,
        }),
      }
    );
    ...
    if (datat.message === "student data saved successfully.") {
